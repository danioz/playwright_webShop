...
export class ProductsPage extends BasePage {
  ...
  readonly productTitle: Locator = this.page.locator('.product-item>.details>h2.product-title');
  ...
  readonly addToCartButton: Locator = this.page.locator("input[id^='add-to-cart-button-']");
  ...
  async selectProduct(productName: string): Promise<void> {
    ...
    } while ((await this.isProductNameVisible(productName)) || (await this.nextButton.isVisible()));
  }
